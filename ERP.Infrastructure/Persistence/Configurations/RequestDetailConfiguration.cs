...
{
    public void Configure(EntityTypeBuilder<RequestDetail> b)
    {
        b.ToTable("REQUESTDET", "dbo");
        b.HasKey(x => new { x.Fran, x.Branch, x.Warehouse, x.RequestType, x.RequestNo, x.RequestSrl });
        ...
        b.Property(x => x.RequestSrl).HasColumnName("REQUESTSRL").HasMaxLength(10).IsRequired();
