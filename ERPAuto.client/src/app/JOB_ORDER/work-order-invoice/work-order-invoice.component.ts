...
@Component({
  selector: 'app-work-order-invoice',
  standalone: true,
  imports: [CommonModule, FormsModule, HttpClientModule],
  templateUrl: './work-order-invoice.component.html',
  styleUrl: './work-order-invoice.component.css',
})
export class WorkOrderInvoiceComponent implements OnInit {
  ...
  goToInvoiceInquiry() {
    this.router.navigate(['/work-order-invoice-inquiry']);
  }
